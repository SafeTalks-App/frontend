...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://be-safetalks.up.railway.app/api/auth/signup', {
        method: 'POST',
      ...
      if (!response.ok) {
        ...
        const loginResponse = await fetch('https://be-safetalks.up.railway.app/api/auth/login', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
